...
public class PostgreSqlUmiServiceTest extends AbstractMetadataServiceSupplierTest<PostgresMetadataProvider> {
    ...
    public void getRootSchemasTest() throws SQLException {
        UmiService umiService = UmiServiceRegister.createRdbUmiService(DataSourceType.PostgreSQL, this.connection);
        //
    ...
    public void getCatalogsTest() throws SQLException {
        RdbUmiService umiService = UmiServiceRegister.createRdbUmiService(DataSourceType.PostgreSQL, this.connection);
