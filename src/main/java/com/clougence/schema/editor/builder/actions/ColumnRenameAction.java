 ...
 */
@Getter
public class ColumnRenameAction extends Action {
    private final EColumn columnInfo;
    private final String  newColumnName;

    public ColumnRenameAction(List<String> sqlString, String catalog, String schema, String table, EColumn columnInfo, String newColumnName) {
