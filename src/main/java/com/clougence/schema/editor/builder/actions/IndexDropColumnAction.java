 ...
 */
@Getter
public class IndexDropColumnAction extends Action {
    private final EIndex       indexInfo;
    private final List<String> needRemoveColumns;

    public IndexDropColumnAction(List<String> sqlString, String catalog, String schema, String table, EIndex indexInfo, List<String> needRemoveColumns) {
