 ...
 */
package com.clougence.schema.metadata.domain.postgres.driver;
 ...
 */
public enum PgServerVersion implements com.clougence.schema.metadata.domain.postgres.driver.PgVersion {
    INVALID("0.0.0"),
    v8_2("8.2.0"),
    v8_3("8.3.0"),
    v8_4("8.4.0"),
     ...
     * {@link com.clougence.schema.metadata.domain.postgres.driver.PgVersion}.</p>
     *
     * <p>If the specified version cannot be parsed, the {@link com.clougence.schema.metadata.domain.postgres.driver.PgVersion#getVersionNum()} will return 0.</p>
     *
     * @param version version in numeric XXYYZZ form, e.g. "090401" for 9.4.1
     * @return a {@link com.clougence.schema.metadata.domain.postgres.driver.PgVersion} representing the specified version string.
     */
    public static com.clougence.schema.metadata.domain.postgres.driver.PgVersion from(String version) {
        final int versionNum = parseServerVersionStr(version);
        return new com.clougence.schema.metadata.domain.postgres.driver.PgVersion() {
            @Override
            public int getVersionNum() {
                return versionNum;
            }
            ...
            public boolean equals(Object obj) {
                if (obj instanceof com.clougence.schema.metadata.domain.postgres.driver.PgVersion) {
