 ...
 */
@Getter
public class PrimaryKeyCreateAction extends Action {
    private final EPrimaryKey primaryInfo;

    public PrimaryKeyCreateAction(List<String> sqlString, String catalog, String schema, String table, EPrimaryKey primaryInfo) {
