 ...
 */
@Getter
public class IndexRenameAction extends Action {
    private final EIndex indexInfo;
    private final String newIndexName;

    public IndexRenameAction(List<String> sqlString, String catalog, String schema, String table, EIndex indexInfo, String newIndexName) {
