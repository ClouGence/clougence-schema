 ...
 */
@Getter
public class PrimaryKeyAddColumnAction extends Action {

    private final EPrimaryKey  primaryInfo;
    private final List<String> needAddColumns;

    public PrimaryKeyAddColumnAction(List<String> sqlString, String catalog, String schema, String table, EPrimaryKey primaryInfo, List<String> needAddColumns){
