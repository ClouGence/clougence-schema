 ...
 */
@Getter
public class IndexCreateAction extends Action {

    private final EIndex indexInfo;

    public IndexCreateAction(List<String> sqlString, String catalog, String schema, String table, EIndex indexInfo){
