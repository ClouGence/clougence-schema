 ...
 */
package com.clougence.commons.convert.convert;
...
import com.clougence.commons.convert.ConversionException;
import com.clougence.commons.convert.Converter;
...
public class ArrayConverter extends AbstractConverter {
     ...
     */
    public void setAllowedChars(final char[] allowedChars) { this.allowedChars = allowedChars; }
     ...
     * is <code>true</code>
     */
    public void setOnlyFirstToString(final boolean onlyFirstToString) { this.onlyFirstToString = onlyFirstToString; }
     ...
     */
    @Override
    protected Class<?> getDefaultType() { return this.defaultTypeInstance.getClass(); }
     ...
     *   <li>{@link Number}, {@link Boolean}  and {@link Date}
