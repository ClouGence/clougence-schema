...
public class TreeNode implements SettingNode {
    ...
    public String[] getValues() { return this.data.getValues(); }
    ...
    public String[] getSubKeys() { return this.subList.keySet().toArray(new String[0]); }
    ...
    public boolean isEmpty() { return this.data.isEmpty() && this.subList.isEmpty() && this.subDefault.isEmpty(); }
