...
import com.clougence.test.config.enums.SelectEnum;
...
public class SettingsTest {
    ...
    public void valueTest() throws Exception {
        ...
        assert 12345678901234567891310123456789012345678913101234567890123456789131012345678901234567891310.12345678901234567891310123456789012345678913101234567890123456789131012345678901234567891310d == settings
            .getDouble("valueGroup.doubleValue_lage");
    ...
    public void valueTest2() throws Exception {
        ...
        assert 12345678901234567891310123456789012345678913101234567890123456789131012345678901234567891310.12345678901234567891310123456789012345678913101234567890123456789131012345678901234567891310d == settings
            .getDoubleArray("valueGroup.doubleValue_lage")[0];
